...
ODE_PARAMETERIZATION = "experimentally anchored synthetic paper_figure ODE benchmark profile"
    ...
    return {
        **ode_profile_manifest_fields(),
        "parameterization_scope": (
            "Experimentally anchored synthetic simulation profile; not a fully "
